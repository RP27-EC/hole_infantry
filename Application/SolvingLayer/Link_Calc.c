...
static void Joint_Torque_Cal(Link_t* Link)
{
  ...
  Link->info->F_Sd_Output_Torque =  (Fbl*l1*arm_sin_f32(phi0 - phi3)*arm_sin_f32(phi1 - phi2))/arm_sin_f32(phi3 - phi2)
	+ (Tp*l1*arm_cos_f32(phi0 - phi3)*arm_sin_f32(phi1 - phi2))/(l0*arm_sin_f32( phi3 - phi2)); 

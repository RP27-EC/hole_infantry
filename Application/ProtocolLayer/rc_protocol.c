...

{
    ...
    rc_sen->info->s1_last = 0;

    rc_sen->info->s2_last = 0;
...

{
    ...
    rc_info->ch0 = DeathZoom(rc_info->ch0, 0, 10);

    rc_info->ch1 = DeathZoom(rc_info->ch1, 0, 10);

    rc_info->ch2 = DeathZoom(rc_info->ch2, 0, 10);

    rc_info->ch3 = DeathZoom(rc_info->ch3, 0, 10);

...
//{
//	cap_tx_buf_1[0] = My_Judge.org_info->power_heat_data.chassis_power_buffer >> 8;
//	cap_tx_buf_1[1] = My_Judge.org_info->power_heat_data.chassis_power_buffer;
//	cap_tx_buf_1[2] = 0;//My_Judge.org_info->power_heat_data.chassis_volt >> 8;
//	cap_tx_buf_1[3] = 0;//My_Judge.org_info->power_heat_data.chassis_volt;
//	cap_tx_buf_1[4] = 0;//My_Judge.org_info->power_heat_data.chassis_current >> 8;
//	cap_tx_buf_1[5] = 0;//My_Judge.org_info->power_heat_data.chassis_current;
//	CAN_SendData(&hfdcan1, 0x2E, &FDCAN1_TxFrame, cap_tx_buf_1);
//}
...
//	cap.record_Y_O_N = 1;
//	uint16_t temp;
//	cap_tx_buf_2[0] = My_Judge.org_info->game_robot_status.chassis_power_limit >> 8;
//	cap_tx_buf_2[1] = My_Judge.org_info->game_robot_status.chassis_power_limit;
//	temp = 300;									//output power
//	cap_tx_buf_2[2] = temp >> 8;
//	cap_tx_buf_2[3] = temp;
//	temp = 150;									//input power
...
//	CAN_SendData(&hfdcan1, 0x2F,&FDCAN1_TxFrame, cap_tx_buf_2);
//}

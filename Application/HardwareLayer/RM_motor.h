...
#define _3508_SELFMADE_TORQUE_CONSTANT     0.2703f //3508自制减速箱的扭矩常数，N*m/A
...
#define _3508_REDUCT_RATIO        (17.255)      //自制减速箱减速比，莞工减速比是(268.f/17.f)，如果修改方向在order_correction里改

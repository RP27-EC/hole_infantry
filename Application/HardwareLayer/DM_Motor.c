...
static void Motor_ReceiveData(Motor_DM_t *motor, uint8_t *rxBuf)
{
	...
	if(motor->type == yaw_6006)
	{
		pmax = P_MAX_6006; pmin = P_MIN_6006; vmax = V_MAX_6006; vmin = V_MIN_6006; tmax = T_MAX_6006;tmin = T_MIN_6006;
	}
	else if(motor->type == dail_4310)
	{
		pmax = P_MAX_4310; pmin = P_MIN_4310; vmax = V_MAX_4310; vmin = V_MIN_4310; tmax = T_MAX_4310;tmin = T_MIN_4310;
	}
	else/*(motor->type == leg_8009)*/
	{
		pmax = P_MAX_8009; pmin = P_MIN_8009; vmax = V_MAX_8009; vmin = V_MIN_8009; tmax = T_MAX_8009;tmin = T_MIN_8009;
	}
...
static void Motor_SetControlPara(Motor_DM_t *motor)
{
	...
	if(motor->type == yaw_6006)
	{
		pmax = P_MAX_6006; pmin = P_MIN_6006; vmax = V_MAX_6006; vmin = V_MIN_6006; cmax = C_MAX_6006;cmin = C_MIN_6006; tmax = T_MAX_6006; tmin = T_MIN_6006;
	}
	else if(motor->type == dail_4310)
	{
		pmax = P_MAX_4310; pmin = P_MIN_4310; vmax = V_MAX_4310; vmin = V_MIN_4310; cmax = C_MAX_4310;cmin = C_MIN_4310; tmax = T_MAX_4310; tmin = T_MIN_4310;
	}
	else/*(motor->type == leg_8009)*/
	{
		pmax = P_MAX_8009; pmin = P_MIN_8009; vmax = V_MAX_8009; vmin = V_MIN_8009; cmax = C_MAX_8009;cmin = C_MIN_8009; tmax = T_MAX_8009; tmin = T_MIN_8009;
	}
